...
$con = new DB();
$seesion_id = $_SESSION['user_id'];
$view = $con->viewDataID('tbook',$seesion_id);
...
<?php include 'view/menu.php' ?>
	...
	?>
        ...
        <thead>
          ...
          <!-- MODAL EDIT -->
          <div class="modal fade" id="modal-edit-<?php echo $data['id'] ?>" tabindex="-1" role="dialog" aria-labelledby="editLabel-<?php echo $data['id']; ?>" aria-hidden="true">
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      <div class="modal-header">
        <h1 class="text-success" id="editLabel-<?php echo $data['id'] ?>">แก้ไขข้อมูล</h1>
      ...
      <form id="edit-data-<?php echo $data['id']; ?>">
      <div class="form-row">
          <div class="form-group col-md-2">
            <label for="term">เทอม</label>
            <select class="form-control" id="term" name="term">
              <?php if ($data['book_term'] == 1){ ?>
      ...
      <option selected="selected">2</option>
          ...
          <div class="form-group col-md-3">
            ...
            <input type="text" class="form-control" name="termyear" id="termyear" value="<?php echo $data['book_termyear'] ?>">
          </div>
      </div>
      ...
      <div class="form-row">
        <div class="form-group col-md-3">
            ...
            <input type="text" class="form-control" id="codesubject" name="subjectcode" value="<?php echo $data['book_subcode'] ?>">
        </div>
        <div class="form-group col-md-6">
            <label for="subjectname">ชื่อวิชา</label>
            <input type="text" class="form-control" name="subjectname" id="subjectname" value="<?php echo $data['book_subname'] ?>">
        </div>
      </div>
      <div class="form-row">
        <div class="form-group col-md-3">
      ...
      <option selected="selected" value="ปวส">ปวส</option>
        ...
        <div class="form-group col-md-6">
            ...
            <input class="form-control" name="teacher" id="teacher" value="<?php echo $data['book_teacher'] ?>">
        </div>
      </div>
      ...
      <div class="form-row">
        <div class="form-group col-md-2">
            ...
            <input type="text" class="form-control" id="id2" name="id2"value="<?php echo $data['book_id2'] ?>">
        </div>
        <div class="form-group col-md-3">
            <label for="bookyear">ปี พ.ศ.</label>
            <input type="text" class="form-control" id="bookyear" name="bookyear" value="<?php echo $data['book_year'] ?>">
        </div>
      </div>
       <h3 class="text-danger">รายละเอียดหนังสือ</h3>
        ...
        <div class="form-group col-md-6">
            ...
            <input type="text" class="form-control" id="bookname" name="bookname" value="<?php echo $data['book_name'] ?>">
        </div>
        <div class="form-group col-md-6">
            <label for="publisher">สำนักพิมพ์</label>
            <input type="text" class="form-control" id="publisher" name="publisher" value="<?php echo $data['book_publisher'] ?>">
        </div>
      </div>
      <div class="form-row">
        <div class="form-group col-md-4">
            ...
            <select class="form-control" id="paper" name="paper">
              ...
              <?php }else if($data['book_paper'] == 'ถนอมสายตา'){ ?>
      ...
      <div class="form-row">
        <div class="form-group col-md-3">
            ...
            <input type="text" class="form-control" name="price" id="price" value="<?php echo $data['book_price'] ?>">
        </div>
        <div class="form-group col-md-5">
            <label for="reason">เหตุผลที่เลือก</label>
            <input type="text" class="form-control" name="reason" id="reason" value="<?php echo $data['book_reason'] ?>">
        </div>
      </div>
      </form>
    </div>
      <div class="modal-footer">
        ...
        <button type="button" class="btn btn-success editdata" data-dismiss="modal" id="<?php echo $data['id']; ?>">บันทึก</button>
      </div>
...
<?php include 'view/menu.php' ?>
	...
	?>
        ...
        <thead>
          ...
          <th>ลบ</th>
           ...
           <?php while ($data2 = $view2->fetch_assoc()) {?>
          <tr id="datainfor">
            <td><?php echo $data2['book_term']; ?></td>
            <td><?php echo $data2['book_termyear']; ?></td>
            <td><?php echo $data2['book_subcode']; ?></td>
            <td><?php echo $data2['book_subname']; ?></td>
            <td><?php echo $data2['book_teacher'] ?></td>
            <td><button class="ui green button" data-toggle="modal" data-target="#modal-edit-<?php echo $data2['id'] ?>"><i class="far fa-edit"></i>&nbsp;&nbsp;แก้ไข</button></td>
            <td><button class="ui red button" onclick="delete_data(<?php echo $data2['id']; ?>);"><i class="far fa-trash-alt"></i>&nbsp;&nbsp;ลบ</button></td>
          </tr>
          <!-- MODAL EDIT -->
  ...
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      ...
      <div class="modal-body">
        <h3 class="text-danger">ภาคเรียน/ปีการศึกษา</h3>
      <form id="edit-data-<?php echo $data2['id']; ?>">
      <div class="form-row">
          <div class="form-group col-md-2">
            <label for="term">เทอม</label>
            <select class="form-control" id="term" name="term">
      ...
      <div class="modal-footer">
        <button type="button" class="btn btn-secondary" data-dismiss="modal">ยกเลิก</button>
        <button type="button" class="btn btn-success editdata" data-dismiss="modal" id="<?php echo $data2['id']; ?>">บันทึก</button>
      </div>
